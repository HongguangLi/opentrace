...
const SKIP_HEADERS = new Set([
  ...
  // AgentTap-internal headers must never leak to the upstream.
  'x-agenttap-token', 'x-opentrace-token', 'x-langfuse-relay-token', 'x-session-id', 'x-service-name',
]);
